...
public class SwerveJoystickCmd extends CommandBase {
    ...
    public void execute() {
        ...
        // double driveSpeed = (joystickMagnitude * (topSpeed.get() ? OIConstants.driverTopMultiplier:
        // OIConstants.driverMultiplier)) * DriveConstants.kTeleDriveMaxSpeedMetersPerSecond;
