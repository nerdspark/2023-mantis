...
public class ChaseTagCommand extends CommandBase {
    ...
    private static final TrapezoidProfile.Constraints OMEGA_CONSTRATINTS = new TrapezoidProfile.Constraints(4, 4);
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber(
                "TagChase robotPose.Angle", robotPose2d.getRotation().getRadians());
        ...
        if (photonRes.hasTargets()) {
            ...
            if (targetOpt.isPresent()) {
                ...
                if (!target.equals(lastTarget)) {
                    ...
                    SmartDashboard.putNumber(
                            "TagChase goal Pose Omega", goalPose.getRotation().getRadians());
                }
            }
        }
