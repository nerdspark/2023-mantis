...
public class LimeLightAlignCommand extends CommandBase {
  ...
  private static final TrapezoidProfile.Constraints DISTANCE_CONSTRAINTS = new TrapezoidProfile.Constraints(2.0, 1.0);
  ...
  public LimeLightAlignCommand(LimeLightSubSystem limeLightSubSystem, SwerveSubsystem driveTrain ) {
    ...
    aimController.setTolerance(0.005);
  ...
  @Override
  public boolean isFinished() { return distanceController.atGoal() && aimController.atGoal(); }
}
