...
//     private static final TrapezoidProfile.Constraints DISTANCE_CONSTRAINTS = new TrapezoidProfile.Constraints(4.0,
// 2.0);
...
//     private final ProfiledPIDController distanceController = new ProfiledPIDController(1.5, 0, 0,
...
//             // SmartDashboard.putNumber("LimeLightAlignCommand botPose Angle",
//             // limeLightSubSystem.getBotPose().getRotation().getDegrees());

//             // SmartDashboard.putNumber("LimeLightAlignCommand target_RobotSpace X",
//             // limeLightSubSystem.getTargetPose3d_RobotSpace().getX());
//             // SmartDashboard.putNumber("LimeLightAlignCommand target_RobotSpace Y",
//             // limeLightSubSystem.getTargetPose3d_RobotSpace().getY());
//             // SmartDashboard.putNumber("LimeLightAlignCommand target_RobotSpace Z",
//             // limeLightSubSystem.getTargetPose3d_RobotSpace().getZ());
//             // SmartDashboard.putNumber("LimeLightAlignCommand target_RobotSpace Angle",
//             // limeLightSubSystem.getTargetPose3d_RobotSpace().toPose2d().getRotation().getDegrees());

//             // SmartDashboard.putNumber("LimeLightAlignCommand robot_TargetSpace X",
//             // limeLightSubSystem.getRobotPose3d_TargetSpace().getX());
//             // SmartDashboard.putNumber("LimeLightAlignCommand robot_TargetSpace Y",
//             // limeLightSubSystem.getRobotPose3d_TargetSpace().getY());
//             // SmartDashboard.putNumber("LimeLightAlignCommand robot_TargetSpace Z",
//             // limeLightSubSystem.getRobotPose3d_TargetSpace().getZ());
//             // SmartDashboard.putNumber("LimeLightAlignCommand robot_TargetSpace Angle",
//             // limeLightSubSystem.getRobotPose3d_TargetSpace().toPose2d().getRotation().getDegrees());

//             // SmartDashboard.putString("LimeLightAlignCommand limelightRetroResults", "before
// limelightRetroResults");

//             var firstTarget = false;
//             // If the target is visible, get the new translation. If the target isn't visible we'll use the last
// known
//             // translation.
