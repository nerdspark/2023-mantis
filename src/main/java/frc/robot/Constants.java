...
public final class Constants {
  ...
  public static class VisionConstants {
     ...
     * robot.
     */
    public static final Transform2d CAMERA_TO_ROBOT = new Transform2d(new Translation2d(0.2, 0.0), new Rotation2d(0.0));

    /**
     * Physical location of the apriltag camera on the robot, relative to the center
     * of the robot.
     */
    public static final Transform3d APRILTAG_CAMERA_TO_ROBOT = new Transform3d(new Translation3d(0.2, 0, -0.90),
        new Rotation3d(0.0, 0.0, -0.1));
