...
public final class FieldConstants {
    ...
    public static final Map<Integer, Pose3d> aprilTags3D = Map.of(
            1,
            new Pose3d(
    ...
    public static final List<AprilTag> aprilTagList =
            Collections.unmodifiableList(List.of(tag1, tag2, tag3, tag4, tag5, tag6, tag7, tag8));
