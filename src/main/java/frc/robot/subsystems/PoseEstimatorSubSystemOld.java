...
public class PoseEstimatorSubSystemOld extends SubsystemBase {
    ...
    public PoseEstimatorSubSystemOld(PhotonCamera photonCamera, SwerveSubsystem drivetrainSubsystem) {
    ...
    public void setCurrentPose(Pose2d newPose) {
        poseEstimator.resetPosition(
                drivetrainSubsystem.getRotation2d(), drivetrainSubsystem.getModulePositions(), newPose);
    }
